...
$templatePath = Decode-Base64 $templatePath
$printerName = Decode-Base64 $printerName
$patientName = Decode-Base64 $patientName
$hospitalName = Decode-Base64 $hospitalName
$receiptDate = Decode-Base64 $receiptDate
$prepareDate = Decode-Base64 $prepareDate
$prescriptionNo = Decode-Base64 $prescriptionNo
$doctorName = Decode-Base64 $doctorName
$medicines = Decode-Base64 $medicines
$medicine = Decode-Base64 $medicine
$medicineName = Decode-Base64 $medicineName
$dailyDose = Decode-Base64 $dailyDose
$singleDose = Decode-Base64 $singleDose
$prescriptionDays = Decode-Base64 $prescriptionDays
$date = Decode-Base64 $date
$pharmacyName = Decode-Base64 $pharmacyName
